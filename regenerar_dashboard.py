...
def match_mo_to_project(mo_upper, display_names):
    ...
    for dname in display_names:
        ...
        if 'OBRA CAMPO' in mo_upper and 'CAMPO' in dname_upper and 'ARANTXA' in dname_upper:
            return dname
        if 'HELENA' in mo_upper and 'HELENA' in dname_upper:
            return dname
