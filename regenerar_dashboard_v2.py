...
lines.append('  <div style="background:var(--card);border:1px solid var(--border);border-radius:8px;padding:12px;text-align:center"><div style="font-size:0.6rem;color:var(--text2);text-transform:uppercase;letter-spacing:1px">Eficiencia Coste/Certif.</div><div style="font-size:1.1rem;font-weight:700;color:var(--accent)">{:.1f}%</div></div>'.format(100-efficiency))
lines.append('  <div style="background:var(--card);border:1px solid var(--border);border-radius:8px;padding:12px;text-align:center"><div style="font-size:0.6rem;color:var(--text2);text-transform:uppercase;letter-spacing:1px">Obras con Beneficio</div><div style="font-size:1.1rem;font-weight:700;color:var(--success)">%d / %d</div></div>' % (projects_with_margin, len(cert_projects)))
lines.append('  <div style="background:var(--card);border:1px solid var(--border);border-radius:8px;padding:12px;text-align:center"><div style="font-size:0.6rem;color:var(--text2);text-transform:uppercase;letter-spacing:1px">Obras con Perdida</div><div style="font-size:1.1rem;font-weight:700;color:var(--red)">%d / %d</div></div>' % (projects_with_loss, len(cert_projects)))
lines.append('  <div style="background:var(--card);border:1px solid var(--border);border-radius:8px;padding:12px;text-align:center"><div style="font-size:0.6rem;color:var(--text2);text-transform:uppercase;letter-spacing:1px">Facturas Directas</div><div style="font-size:1.1rem;font-weight:700;color:var(--orange)">{:,}</div></div>'.format(total_facturas_dir))
lines.append('  <div style="background:var(--card);border:1px solid var(--border);border-radius:8px;padding:12px;text-align:center"><div style="font-size:0.6rem;color:var(--text2);text-transform:uppercase;letter-spacing:1px">Horas Mano de Obra</div><div style="font-size:1.1rem;font-weight:700;color:var(--purple)">{:,} h</div></div>'.format(sum_horas))
lines.append('  <div style="background:var(--card);border:1px solid var(--border);border-radius:8px;padding:12px;text-align:center"><div style="font-size:0.6rem;color:var(--text2);text-transform:uppercase;letter-spacing:1px">Total Obras</div><div style="font-size:1.1rem;font-weight:700;color:var(--cyan)">{}</div></div>'.format(len(cert_projects)))
lines.append('</div>')
